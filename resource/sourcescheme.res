...
Scheme
{
	...
	Fonts
	{
		"DefaultFixedOutline" //edited by INsane 2010 for small netgraph font on all screen sizes
		{
            "1" 
            {
                "name"         	"TF2 Secondary"		// Standard is 'Lucida Console' Options are 'Microsoft Sans Serif' 'Georgia' 'Impact' 'Arial MT' and the best for small = 'Haettenschweiler' but is a MS office and Win7 font, can be downloaded, google 'Haettenschweiler' and install in C:/Windows/Fonts
	...
	CustomFontFiles
	{
		...
		"20"
		{
			"font" "resource/TF2-Secondary-Fixed.ttf"
